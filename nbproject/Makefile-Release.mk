...
${OBJECTDIR}/arregloSalon.o: arregloSalon.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/arregloSalon.o arregloSalon.cpp
...
${OBJECTDIR}/gimnasio.o: gimnasio.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gimnasio.o gimnasio.cpp

${OBJECTDIR}/instruccion.o: instruccion.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/instruccion.o instruccion.cpp

${OBJECTDIR}/instructor.o: instructor.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/instructor.o instructor.cpp
...
${OBJECTDIR}/listaClase.o: listaClase.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/listaClase.o listaClase.cpp

${OBJECTDIR}/listaInstructor.o: listaInstructor.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/listaInstructor.o listaInstructor.cpp

${OBJECTDIR}/listaRegistro.o: listaRegistro.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/listaRegistro.o listaRegistro.cpp

${OBJECTDIR}/listaRutina.o: listaRutina.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/listaRutina.o listaRutina.cpp

${OBJECTDIR}/listaSocio.o: listaSocio.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/listaSocio.o listaSocio.cpp
...
${OBJECTDIR}/nodoClase.o: nodoClase.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nodoClase.o nodoClase.cpp

${OBJECTDIR}/nodoInstructor.o: nodoInstructor.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nodoInstructor.o nodoInstructor.cpp

${OBJECTDIR}/nodoRegistro.o: nodoRegistro.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nodoRegistro.o nodoRegistro.cpp

${OBJECTDIR}/nodoRutina.o: nodoRutina.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nodoRutina.o nodoRutina.cpp

${OBJECTDIR}/nodoSocio.o: nodoSocio.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/nodoSocio.o nodoSocio.cpp
...
${OBJECTDIR}/rutina.o: rutina.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/rutina.o rutina.cpp

${OBJECTDIR}/salon.o: salon.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/salon.o salon.cpp
